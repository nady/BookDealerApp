...
.controller('DealerListController',function($scope,$state,popupService,$window,Dealer){
...
.controller('DealerViewController',function($scope,$stateParams,Dealer){

    $scope.dealer=Dealer.get({id:$stateParams.id});

})
.controller('BookListController',function($scope,$state,popupService,$window,Book,Magazine){
